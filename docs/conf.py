...
# -*- coding: utf-8 -*-
#
# copycat documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'copycat.tex', 'copycat Documentation',
     'Heinz Riener', 'manual'),
]
...
man_pages = [
    (master_doc, 'copycat', 'copycat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'copycat', 'copycat Documentation',
     author, 'copycat', 'One line description of project.',
     'Miscellaneous'),
]
...
breathe_projects = {"copycat": "doxyxml/xml"}
breathe_default_project = "copycat"
